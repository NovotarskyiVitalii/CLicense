        ...
        void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                try
                {
                    ...
                    ReportViewer1.ServerReport.ReportPath = "/CLicenseReports/LicenseOfUser";
...
<body>
    <form id="form1" runat="server">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" ProcessingMode="Remote" AsyncRendering="false" Width="100%">
            ...
            <%--<ServerReport  ReportServerUrl="http://i0staff04.nbu.bank.gov.ua/StaffReportServer" Timeout="900000" />--%>
        </rsweb:ReportViewer>
